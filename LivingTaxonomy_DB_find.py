...
def main(query):
    ...
    if query:
        ...
        return(open("static/index.html").read().replace("images/Background.png", random.choice(df_wks['Image'].tolist()).replace("https://drive.google.com/open?id=", "http://drive.google.com/uc?export=view&id=")))
